...
### 文档、笔记或博客
 ...
 - [CodeIgnoter用户指南（v2.2.0中文版）](https://github.com/ycrao/codeigniter_user_guide_chs)
 - 笔记：[MyNotes](https://github.com/ycrao/mynotes)

### 项目或类库

 - [芽丝内容管理框架 - 基础版](https://github.com/yascmf/base)
 - [Identity Card](https://github.com/douyasi/identity-card)：Identity Card（中国大陆）公民身份证类，支持 `Laravel` ；另外有 `Typescript/Node/Javascript` 与 `Rust` 的实现版本。
 - [TinyMe](https://github.com/ycrao/tinyme)： 基于 `flight` 与 `medoo` 构建的微型php框架
 - [laravel-editor-md](https://github.com/douyasi/laravel-editor-md)：editor.md for Laravel
 - [laravel-wang-editor](https://github.com/douyasi/laravel-wang-editor)：wangEditor for Laravel  
...
### 杂项演示
 ...
 - [AHK CKEditor](http://raoyc.com/ckeditor/samples/editor.html)
 - 每日一文（不可用）
 - 译文：[Bash 中文指南](https://github.com/ycrao/bash-guide)

### 爱好

 - 软路由： PVE+iKuai+iStoreOS
 - Vibe Coding：[ai-vibe-coding-products](https://github.com/ycrao/ai-vibe-coding-products)

![Snipaste_2025-11-05_16-36-00.png](https://douyasi.com/usr/uploads/2025/11/1229707115.png)
